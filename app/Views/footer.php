<footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Omar Cárcamo <?php echo date('Y'); ?> </div>
                            <div>
        ...
        <script src="<?php echo base_url(); ?>/js/cdn.jsdelivr.net_npm_bootstrap@4.6.0_dist_js_bootstrap.bundle.min.js" crossorigin="anonymous"></script>
